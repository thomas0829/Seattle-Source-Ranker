...
export default function App() {
    ...
    const loadSelectedLanguages = async () => {
        ...
        const maxPagesToLoadPerLang =
            Math.ceil(reposNeeded / selectedLanguages.length / pageSize) + 1;
    ...
    const getRepoDescription = (repo) => {
        ...
        return (
            <div>
                ...
                {hasTechStack && (
                    <div style={{ marginBottom: "8px" }}>
                        <strong>Tech Stack:</strong> {details.topics
                        .slice(0, 5)
                        .join(", ")}
                    </div>
                )}
    ...
    return (
        <div className="container">
                  ...
                  <strong>All</strong>
                    ...
                    >
                        ...
                        selectedLanguages.length > 0 ? (
                            ...
                            <>
                                Showing{" "}
                                {repos.length > 0 ? (currentPage - 1) * 50 + 1 : 0}-
                                {repos.length > 0
            ...
            {activePage === "scoring" && <ScoringPage />}
