...
- **440,886 projects** tracked across Seattle's developer community
- **2,887,379 total stars** accumulated by Seattle projects
- **28,669 users** collected in latest run
- **1,115 Python projects** published on PyPI (2.00% of Python projects)
- **28 Python projects** in global Top 15,000 PyPI packages (0.07% of Python projects)
- Last updated: 2026-02-23 01:42:58 PST
