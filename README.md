...
- **434,144 projects** tracked across Seattle's developer community
- **2,841,783 total stars** accumulated by Seattle projects
- **28,381 users** collected in latest run
- **1,083 Python projects** published on PyPI (2.00% of Python projects)
- **28 Python projects** in global Top 15,000 PyPI packages (0.07% of Python projects)
- Last updated: 2025-12-25 01:43:58 PST
